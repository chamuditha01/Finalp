        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption">
              ...
              <p className="para__text">
                Our surgery theater is fully equipped and capable of performing
                variety of surgeries for your canine and feline friends.
              </p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              ...
              <p className="para__text">
                Home Visits are when a pet sitter comes over to your home for a
                short visit to check in on your pet, feed and water them, and
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              ...
              <p className="para__text">
                Inward care and Boarding will help clients to leave their pet’s
                with us when they are sick or to board them when necessary
              </p>
            </div>
          </div>
          <div className="carousel-item">
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              ...
              <p className="para__text">
                Our OPD is functioning from 8.00am to 8.00pm to give you the
                best veterinary care and friendly service.
              </p>
            </div>
          </div>
        </div>
